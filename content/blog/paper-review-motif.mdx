...
Rewards that come from within the agent itself, rather than from the environment. These are particularly useful for exploration and learning in sparse reward settings <Sidenote> Hello again </Sidenote>.
